...
LIBCAPBUNDLE?=	${LIBDESTDIR}${LIBDIR_BASE}/libcapbundle.a
LIBCAPRECLAIM?=	${LIBDESTDIR}${LIBDIR_BASE}/libcapreclaim.a
LIBCRYPTOCMP?=	${LIBDESTDIR}${LIBDIR_BASE}/libcryptocmp.a
LIBCRYPTODESC?=	${LIBDESTDIR}${LIBDIR_BASE}/libcryptodesc.a
LIBDEVICECMP?=	${LIBDESTDIR}${LIBDIR_BASE}/libdevicecmp.a
LIBAPPUTILS?=	${LIBDESTDIR}${LIBDIR_BASE}/libapputils.a
LIBARCHIVE?=	${LIBDESTDIR}${LIBDIR_BASE}/libarchive.a
LIBAUDITCMP?=	${LIBDESTDIR}${LIBDIR_BASE}/libauditcmp.a
...
LIBBLE?=	${LIBDESTDIR}${LIBDIR_BASE}/libble.a
LIBBLEMESH?=	${LIBDESTDIR}${LIBDIR_BASE}/libblemesh.a
...
LIBCHANNEL?=	${LIBDESTDIR}${LIBDIR_BASE}/libchannel.a
...
LIBKLDMGR?=	${LIBDESTDIR}${LIBDIR_BASE}/libkldmgr.a
LIBLOGCMP?=	${LIBDESTDIR}${LIBDIR_BASE}/liblogcmp.a
LIBNOTIFY?=	${LIBDESTDIR}${LIBDIR_BASE}/libnotify.a
LIBREBOOTCTL?=	${LIBDESTDIR}${LIBDIR_BASE}/librebootctl.a
LIBTRACECMP?=	${LIBDESTDIR}${LIBDIR_BASE}/libtracecmp.a
...
LIBNETWORKCMP?=	${LIBDESTDIR}${LIBDIR_BASE}/libnetworkcmp.a
LIBSYSCTLCMP?=	${LIBDESTDIR}${LIBDIR_BASE}/libsysctlcmp.a
LIBTIMECMP?=	${LIBDESTDIR}${LIBDIR_BASE}/libtimecmp.a
LIBPOWERCMP?=	${LIBDESTDIR}${LIBDIR_BASE}/libpowercmp.a
...
LIBOES?=	${LIBDESTDIR}${LIBDIR_BASE}/liboes.a
LIBOPENCSD?=	${LIBDESTDIR}${LIBDIR_BASE}/libopencsd.a
LIBCAPSULERT?=	${LIBDESTDIR}${LIBDIR_BASE}/libcapsulert.a
...
LIBSERVICE?=	${LIBDESTDIR}${LIBDIR_BASE}/libservice.a
LIBSHMRING?=	${LIBDESTDIR}${LIBDIR_BASE}/libshmring.a
LIBCAPABILITY?=	${LIBDESTDIR}${LIBDIR_BASE}/libcapability.a
...
LIBTRUSTEDZFS?=	${LIBDESTDIR}${LIBDIR_BASE}/libtrustedzfs.a
LIBBSDFILESYSTEM?=	${LIBDESTDIR}${LIBDIR_BASE}/libbsdfilesystem.a
