...
const char *syscallnames[] = {
	...
	"cap_xfer_rights_limit",			/* 606 = cap_xfer_rights_limit */
	"cap_xfer_ioctls_limit",			/* 607 = cap_xfer_ioctls_limit */
	"cap_xfer_fcntls_limit",			/* 608 = cap_xfer_fcntls_limit */
	"#609",			/* 609 =  */
	"#610",			/* 610 =  */
	"#611",			/* 611 =  */
	"#612",			/* 612 =  */
	...
	"squeue_setup",			/* 636 = squeue_setup */
	"squeue_enter",			/* 637 = squeue_enter */
	"squeue_register",			/* 638 = squeue_register */
};
