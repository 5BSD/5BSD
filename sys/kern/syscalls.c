...
const char *syscallnames[] = {
	...
	"cap_fchmod",			/* 606 = cap_fchmod */
	"cap_fchown",			/* 607 = cap_fchown */
	"cap_fchflags",			/* 608 = cap_fchflags */
	"cap_futimes",			/* 609 = cap_futimes */
	"cap___acl_get_fd",			/* 610 = cap___acl_get_fd */
	"cap___acl_set_fd",			/* 611 = cap___acl_set_fd */
	"cap___acl_delete_fd",			/* 612 = cap___acl_delete_fd */
	"cap_extattr_set_fd",			/* 613 = cap_extattr_set_fd */
	"cap_extattr_get_fd",			/* 614 = cap_extattr_get_fd */
	"cap_extattr_delete_fd",			/* 615 = cap_extattr_delete_fd */
	"cap_extattr_list_fd",			/* 616 = cap_extattr_list_fd */
	"cap_fstatfs",			/* 617 = cap_fstatfs */
	"cap_bind",			/* 618 = cap_bind */
	"cap_listen",			/* 619 = cap_listen */
	"cap_accept",			/* 620 = cap_accept */
	"cap_connect",			/* 621 = cap_connect */
	"cap_sendmsg",			/* 622 = cap_sendmsg */
	"cap_recvmsg",			/* 623 = cap_recvmsg */
	"cap_setsockopt",			/* 624 = cap_setsockopt */
	"cap_ioctl",			/* 625 = cap_ioctl */
	"cap_mmap",			/* 626 = cap_mmap */
