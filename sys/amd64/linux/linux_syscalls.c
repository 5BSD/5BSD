...
const char *linux_syscallnames[] = {
	...
	"mlock",			/* 149 = mlock */
	"munlock",			/* 150 = munlock */
	"linux_mlockall",			/* 151 = linux_mlockall */
	...
	"linux_uretprobe",			/* 335 = linux_uretprobe */
	"linux_uprobe",			/* 336 = linux_uprobe */
	"#337",			/* 337 = nosys */
	"#338",			/* 338 = nosys */
	"#339",			/* 339 = nosys */
	"#340",			/* 340 = nosys */
	...
	"linux_quotactl_fd64",			/* 443 = linux_quotactl_fd64 */
	...
	"linux_futex_wake",			/* 454 = linux_futex_wake */
	"linux_futex_wait",			/* 455 = linux_futex_wait */
	"linux_futex_requeue",			/* 456 = linux_futex_requeue */
	"linux_statmount",			/* 457 = linux_statmount */
	"linux_listmount",			/* 458 = linux_listmount */
	"linux_lsm_get_self_attr",			/* 459 = linux_lsm_get_self_attr */
	"linux_lsm_set_self_attr",			/* 460 = linux_lsm_set_self_attr */
	"linux_lsm_list_modules",			/* 461 = linux_lsm_list_modules */
	"linux_mseal",			/* 462 = linux_mseal */
	"linux_setxattrat",			/* 463 = linux_setxattrat */
	"linux_getxattrat",			/* 464 = linux_getxattrat */
	"linux_listxattrat",			/* 465 = linux_listxattrat */
	"linux_removexattrat",			/* 466 = linux_removexattrat */
	"linux_open_tree_attr",			/* 467 = linux_open_tree_attr */
	"linux_file_getattr",			/* 468 = linux_file_getattr */
	"linux_file_setattr",			/* 469 = linux_file_setattr */
	"linux_listns",			/* 470 = linux_listns */
	"linux_rseq_slice_yield",			/* 471 = linux_rseq_slice_yield */
	"linux_fchroot",			/* 472 = linux_fchroot */
};
