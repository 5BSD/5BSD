 ...
 *
 * mac_capability_capprotect — wire protocol for Capability Protection.
 *
 * Shared between kernel and userspace.  Include this header
 * to construct MAC_CAPABILITY_CALL requests for the "capprotect" service.
 */

#ifndef _DEV_MAC_CAPABILITY_MAC_CAPABILITY_CAPPROTECT_PROTO_H_
#define _DEV_MAC_CAPABILITY_MAC_CAPABILITY_CAPPROTECT_PROTO_H_
...
#endif /* _DEV_MAC_CAPABILITY_MAC_CAPABILITY_CAPPROTECT_PROTO_H_ */
