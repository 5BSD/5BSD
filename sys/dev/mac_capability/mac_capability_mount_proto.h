 ...
 *
 * mac_capability_mount — wire protocol for the mount service.
 *
...
#ifndef _DEV_MAC_CAPABILITY_MAC_CAPABILITY_MOUNT_PROTO_H_
#define _DEV_MAC_CAPABILITY_MAC_CAPABILITY_MOUNT_PROTO_H_
 ...
 * Request: mount
 *
 * mac_capability_mount is a capability-mediated mount gateway, not a full
 ...
 *   - mac_capability_mount checks request shape, allowed fstype, flags, and path
...
#endif /* _DEV_MAC_CAPABILITY_MAC_CAPABILITY_MOUNT_PROTO_H_ */
