 ...
 *
 * cmi_kernelstore — wire protocol for the shared key-value store.
 *
 * Shared between kernel and userspace.  Include this header
 * to construct CMI_CALL requests for the "kernelstore" service.
 */

#ifndef _DEV_CMI_CMI_KERNELSTORE_PROTO_H_
#define _DEV_CMI_CMI_KERNELSTORE_PROTO_H_
...
#endif /* _DEV_CMI_CMI_KERNELSTORE_PROTO_H_ */
