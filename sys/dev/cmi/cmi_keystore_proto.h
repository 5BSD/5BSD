 ...
 *
 * cmi_keystore — wire protocol for the async key-value test fixture.
 *
 * This service exists for framework testing.  It exercises async
 * messaging, credential access, and badges.
 */

#ifndef _DEV_CMI_CMI_KEYSTORE_PROTO_H_
#define _DEV_CMI_CMI_KEYSTORE_PROTO_H_
...
#endif /* _DEV_CMI_CMI_KEYSTORE_PROTO_H_ */
