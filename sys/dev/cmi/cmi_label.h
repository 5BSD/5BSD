 ...
 *
 * cmi_label — per-credential program identity.
 *
 * The CMI runtime attaches a cryptographic nonce to every credential.
 ...
 *
 * Call cmi_proc_nonce() to read it.  Returns 0 if not available.
 * The internal label struct is hidden — additional fields may be
 * added without changing consumers.
 */

#ifndef _DEV_CMI_CMI_LABEL_H_
#define _DEV_CMI_CMI_LABEL_H_
 ...
 */
uint64_t	cmi_proc_nonce(struct ucred *cred);

#endif /* _KERNEL */
#endif /* _DEV_CMI_CMI_LABEL_H_ */
