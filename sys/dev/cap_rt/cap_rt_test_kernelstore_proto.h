 ...
 *
 * cap_rt_test_kernelstore — wire protocol for the shared key-value store.
 *
 * Shared between kernel and userspace.  Include this header
 * to construct CAP_RT_CALL requests for the "test_kernelstore" service.
 */

#ifndef _DEV_CAP_RT_CAP_RT_TEST_KERNELSTORE_PROTO_H_
#define _DEV_CAP_RT_CAP_RT_TEST_KERNELSTORE_PROTO_H_
...
#endif /* _DEV_CAP_RT_CAP_RT_TEST_KERNELSTORE_PROTO_H_ */
