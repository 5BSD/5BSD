 ...
 * inherit it.  This predicate is the single decision point switchboard's command
 ...
 */
#ifndef SWITCHBOARD_AMBIENT_HYGIENE_H
#define SWITCHBOARD_AMBIENT_HYGIENE_H
 ...
 *
 * A unit that stays root (have_creds false, i.e. it runs as switchboard's own
 ...
 * system.switchboard / system.lifecycle over an inherited SYSTEM channel and drive
...
#endif /* SWITCHBOARD_AMBIENT_HYGIENE_H */
