 ...
 *
 * Direct mac_capability operations for switchboard.
 *
 ...
 * access needed.  capsule hands switchboard one instance of each
 * mintable service; switchboard mints fresh instances from those.
 *
...
#define	MAC_CAP_DIRECT_TIMEOUT_MS	SWITCHBOARD_RPC_TIMEOUT_MS
 ...
 * These operate on coalition fds that switchboard owns directly.
 */
int
