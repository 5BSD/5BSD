 ...
 *
 * switchboard control-plane authorization gate (P3, sctl.c).
 *
 * The capability control channel (system.switchboard) exposes read-only status
 ...
 */
#ifndef SWITCHBOARD_SCTL_GATE_H
#define SWITCHBOARD_SCTL_GATE_H

#include <sys/types.h>
#include <stdbool.h>
#include <stdint.h>

#include "switchboard_ctl.h"		/* SCTL_OP_* */
#include "switchboard_svc_proto.h"		/* SVC_RIGHTS_ADMIN */

/*
 * Whether a control op mutates switchboard state and therefore requires the
