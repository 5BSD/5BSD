...
/*
 * A command that does not drop credentials runs as switchboard's own uid (root)
 ...
 * unprivileged oneshot cannot look up system.switchboard / system.lifecycle over
