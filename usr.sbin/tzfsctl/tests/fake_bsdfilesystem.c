...
static struct bsdfilesystem_client fake_client;
...
void
bsdfilesystem_close(struct bsdfilesystem_client *client)
{
...
static int
validate_client(struct bsdfilesystem_client *client, const char *operation)
{
...
int
bsdfilesystem_request(struct bsdfilesystem_client *client, const struct bsdfilesystem_req *req,
...
int
bsdfilesystem_release(struct bsdfilesystem_client *client, const char *dataset)
{
...
int
bsdfilesystem_ping(struct bsdfilesystem_client *client)
{
