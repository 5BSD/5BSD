 ...
 *
 * MAC_CAPABILITY token minting and channel/coalition creation for capsule.
 */
...
/*
 * Mint a network isolation access token for one endpoint.  Capsule
 ...
 * Sets *capsule_end and *child_end to the two connected fds.
 * Returns 0 on success, -1 on failure.
 */
int
mac_capability_create_channel(int *capsule_end, int *child_end)
{
