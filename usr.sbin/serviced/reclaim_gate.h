 ...
 *
 * serviced label-reclaim decision points (docs/capability-lifecycle-cleanup.md).
 *
 * The operator reclaim op (SCTL_OP_RECLAIM, servicectl reclaim, driven by the
 ...
 */
#ifndef SERVICED_RECLAIM_GATE_H
#define SERVICED_RECLAIM_GATE_H
...
#include "serviced_svc_proto.h"		/* struct svc_reclaim_label_msg */
