...
static inline bool
claim_jail_entry_covers(const struct oracled_jail_claim *claim,
...
static inline bool
claim_jail_covered(const struct oracled_config *cfg,
    const struct oracled_jail_claim *req)
{
	unsigned i;
...
static inline bool
claim_system_covered(const struct oracled_config *cfg, const char *gate_name)
{
	int bit;
