...
END {
	...
	print ""
	print "/*"
	print " * Assignments Core 6.3 prints as \"Previously used\": Vol 1 Part E"
	print " * Section 2.4.2; Vol 3 Part A Table 2.1; Part F Table 3.42; Part G"
	print " * Table 3.5; Part H Table 3.3/Figure 3.11.  The four signing"
	print " * assignments are current features of Core 5.2, this stack's target,"
	print " * and are implemented; 6.3 prints them this way because 6.3 removed"
	print " * data signing (Vol 1 Part C Section 17.2).  A2MP CID 0x0003 was"
	print " * removed in 5.3 and is not implemented."
	print " */"
