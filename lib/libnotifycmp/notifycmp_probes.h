...
#else
#define	NOTIFYCMP_PROBE_RPC(a, b)	((void)0)
#define	NOTIFYCMP_PROBE_PUBLISH(a, b, c)	((void)0)
#define	NOTIFYCMP_PROBE_NEXT(a, b)	((void)0)
#define	NOTIFYCMP_PROBE_REJECT(a, b)	((void)0)
#endif
