 ...
 *
 * capsule control socket wire protocol.
 *
 * Shared between the daemon, capsulectl(8), and future libraries.
 *
...
#ifndef CAPSULE_CTL_H
#define CAPSULE_CTL_H

#include <sys/types.h>

/* Default socket path — used by capsulectl to connect.
