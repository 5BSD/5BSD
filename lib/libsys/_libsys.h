...
typedef int (__sys_cap_fchmod_t)(int, mode_t);
typedef int (__sys_cap_fchown_t)(int, uid_t, gid_t);
typedef int (__sys_cap_fchflags_t)(int, u_long);
typedef int (__sys_cap_futimes_t)(int, const struct timeval *);
typedef int (__sys_cap___acl_get_fd_t)(int, __acl_type_t, struct acl *);
typedef int (__sys_cap___acl_set_fd_t)(int, __acl_type_t, const struct acl *);
typedef int (__sys_cap___acl_delete_fd_t)(int, __acl_type_t);
typedef ssize_t (__sys_cap_extattr_set_fd_t)(int, int, const char *, void *, size_t);
typedef ssize_t (__sys_cap_extattr_get_fd_t)(int, int, const char *, void *, size_t);
typedef int (__sys_cap_extattr_delete_fd_t)(int, int, const char *);
typedef ssize_t (__sys_cap_extattr_list_fd_t)(int, int, void *, size_t);
typedef int (__sys_cap_fstatfs_t)(int, struct statfs *);
typedef int (__sys_cap_bind_t)(int, const struct sockaddr *, __socklen_t);
typedef int (__sys_cap_listen_t)(int, int);
typedef int (__sys_cap_accept_t)(int, struct sockaddr *, __socklen_t *);
typedef int (__sys_cap_connect_t)(int, const struct sockaddr *, __socklen_t);
typedef ssize_t (__sys_cap_sendmsg_t)(int, const struct msghdr *, int);
typedef ssize_t (__sys_cap_recvmsg_t)(int, struct msghdr *, int);
typedef int (__sys_cap_setsockopt_t)(int, int, int, const void *, __socklen_t);
typedef int (__sys_cap_ioctl_t)(int, u_long, char *);
typedef void * (__sys_cap_mmap_t)(void *, size_t, int, int, int, off_t);
...
int __sys_cap_fchmod(int fd, mode_t mode);
int __sys_cap_fchown(int fd, uid_t uid, gid_t gid);
int __sys_cap_fchflags(int fd, u_long flags);
int __sys_cap_futimes(int fd, const struct timeval * times);
int __sys_cap___acl_get_fd(int filedes, __acl_type_t type, struct acl * aclp);
int __sys_cap___acl_set_fd(int filedes, __acl_type_t type, const struct acl * aclp);
int __sys_cap___acl_delete_fd(int filedes, __acl_type_t type);
ssize_t __sys_cap_extattr_set_fd(int fd, int attrnamespace, const char * attrname, void * data, size_t nbytes);
ssize_t __sys_cap_extattr_get_fd(int fd, int attrnamespace, const char * attrname, void * data, size_t nbytes);
int __sys_cap_extattr_delete_fd(int fd, int attrnamespace, const char * attrname);
ssize_t __sys_cap_extattr_list_fd(int fd, int attrnamespace, void * data, size_t nbytes);
int __sys_cap_fstatfs(int fd, struct statfs * buf);
int __sys_cap_bind(int s, const struct sockaddr * name, __socklen_t namelen);
int __sys_cap_listen(int s, int backlog);
int __sys_cap_accept(int s, struct sockaddr * name, __socklen_t * anamelen);
int __sys_cap_connect(int s, const struct sockaddr * name, __socklen_t namelen);
ssize_t __sys_cap_sendmsg(int s, const struct msghdr * msg, int flags);
ssize_t __sys_cap_recvmsg(int s, struct msghdr * msg, int flags);
int __sys_cap_setsockopt(int s, int level, int name, const void * val, __socklen_t valsize);
int __sys_cap_ioctl(int fd, u_long com, char * data);
void * __sys_cap_mmap(void * addr, size_t len, int prot, int flags, int fd, off_t pos);
