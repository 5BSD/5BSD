...
typedef int (__sys_cap_xfer_rights_limit_t)(int, const cap_rights_t *);
typedef int (__sys_cap_xfer_ioctls_limit_t)(int, const u_long *, size_t);
typedef int (__sys_cap_xfer_fcntls_limit_t)(int, uint32_t);
...
int __sys_cap_xfer_rights_limit(int fd, const cap_rights_t * rightsp);
int __sys_cap_xfer_ioctls_limit(int fd, const u_long * cmds, size_t ncmds);
int __sys_cap_xfer_fcntls_limit(int fd, uint32_t fcntlrights);
